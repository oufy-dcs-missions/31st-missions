    ...
    if sam_site_jtacs_enable == true then
        if sam1_spawned == false then
            ...
            if jtac_smoke_targets == true then
                JTACAutoLase(JTAC_DRONE_SAM1_NAME, 1688, true, "all")
            end

            if jtac_smoke_targets == false then
                JTACAutoLase(JTAC_DRONE_SAM1_NAME, 1688, false, "all")
            end
...
function activate_SAM2_jtac()
    if sam_site_jtacs_enable == true then
        if sam2_spawned == false then
            ...
            if jtac_smoke_targets == true then
                JTACAutoLase(JTAC_DRONE_SAM2_NAME, 1688, true, "all")
            end

            if jtac_smoke_targets == false then
                JTACAutoLase(JTAC_DRONE_SAM2_NAME, 1688, false, "all")
            end
...
function activate_SAM3_jtac()
    if sam_site_jtacs_enable == true then
        if sam3_spawned == false then
            ...
            if jtac_smoke_targets == true then
                JTACAutoLase(JTAC_DRONE_SAM3_NAME, 1688, true, "all")
            end

            if jtac_smoke_targets == false then
                JTACAutoLase(JTAC_DRONE_SAM3_NAME, 1688, false, "all")
            end
...
--SAM4---
function activate_SAM4_jtac()
    if sam_site_jtacs_enable == true then
        if sam4_spawned == false then
            JTAC_DRONE_SAM4 = JTAC_DRONE_SAM:SpawnInZone( SAM4, true )
            JTAC_DRONE_SAM4_NAME = JTAC_DRONE_SAM4:GetName()

            if jtac_smoke_targets == true then
                JTACAutoLase(JTAC_DRONE_SAM4_NAME, 1688, true, "all")
            end

            if jtac_smoke_targets == false then
                JTACAutoLase(JTAC_DRONE_SAM4_NAME, 1688, false, "all")
            end
            env.info("JTAC:  ".. JTAC_DRONE_SAM4_NAME .."  spawned!")
        end
        sam3_spawned = true
    end
end

function destroy_SAM4_jtac()
    Group.getByName(JTAC_DRONE_SAM4_NAME):destroy()
    env.info("JTAC: " .. JTAC_DRONE_SAM4_NAME .. " destroyed!")
end


--SAM5---
function activate_SAM5_jtac()
    if sam_site_jtacs_enable == true then
        if sam5_spawned == false then
            JTAC_DRONE_SAM5 = JTAC_DRONE_SAM:SpawnInZone( SAM5, true )
            JTAC_DRONE_SAM5_NAME = JTAC_DRONE_SAM5:GetName()

            if jtac_smoke_targets == true then
                JTACAutoLase(JTAC_DRONE_SAM5_NAME, 1688, true, "all")
            end

            if jtac_smoke_targets == false then
                JTACAutoLase(JTAC_DRONE_SAM5_NAME, 1688, false, "all")
            end
            env.info("JTAC:  ".. JTAC_DRONE_SAM5_NAME .."  spawned!")
        end
        sam5_spawned = true
    end
end

function destroy_SAM5_jtac()
    Group.getByName(JTAC_DRONE_SAM5_NAME):destroy()
    env.info("JTAC: " .. JTAC_DRONE_SAM5_NAME .. " destroyed!")
end
...
if jtac_smoke_targets == true then
JTACAutoLase(JTAC_DRONE_A2G1_NAME, 1688, true, "all")
end

if jtac_smoke_targets == false then
JTACAutoLase(JTAC_DRONE_A2G1_NAME, 1688, false, "all")
end
...
if jtac_smoke_targets == true then
JTACAutoLase(JTAC_DRONE_A2G2_NAME, 1688, true, "all")
end

if jtac_smoke_targets == false then
JTACAutoLase(JTAC_DRONE_A2G2_NAME, 1688, false, "all")
end
...
if jtac_smoke_targets == true then
JTACAutoLase(JTAC_DRONE_A2G3_NAME, 1688, true, "all")
end

if jtac_smoke_targets == false then
JTACAutoLase(JTAC_DRONE_A2G3_NAME, 1688, false, "all")
end
...
if jtac_smoke_targets == true then
JTACAutoLase(JTAC_DRONE_A2G4_NAME, 1688, true, "all")
end

if jtac_smoke_targets == false then
JTACAutoLase(JTAC_DRONE_A2G4_NAME, 1688, false, "all")
end
...
if jtac_smoke_targets == true then
JTACAutoLase(JTAC_DRONE_A2G5_NAME, 1688, true, "all")
end

if jtac_smoke_targets == false then
JTACAutoLase(JTAC_DRONE_A2G5_NAME, 1688, false, "all")
end
...
if jtac_smoke_targets == true then
JTACAutoLase(JTAC_DRONE_A2G6_NAME, 1688, true, "all")
end

if jtac_smoke_targets == false then
JTACAutoLase(JTAC_DRONE_A2G6_NAME, 1688, false, "all")
end
...
if jtac_smoke_targets == true then
JTACAutoLase(JTAC_DRONE_A2G7_NAME, 1688, true, "all")
end

if jtac_smoke_targets == false then
JTACAutoLase(JTAC_DRONE_A2G7_NAME, 1688, false, "all")
end
...
if jtac_smoke_targets == true then
JTACAutoLase(JTAC_DRONE_A2G8_NAME, 1688, true, "all")
end

if jtac_smoke_targets == false then
JTACAutoLase(JTAC_DRONE_A2G8_NAME, 1688, false, "all")
end
...
if jtac_smoke_targets == true then
JTACAutoLase(JTAC_DRONE_A2G9_NAME, 1688, true, "all")
end

if jtac_smoke_targets == false then
JTACAutoLase(JTAC_DRONE_A2G9_NAME, 1688, false, "all")
end
...
if jtac_smoke_targets == true then
JTACAutoLase(JTAC_DRONE_A2G10_NAME, 1688, true, "all")
end

if jtac_smoke_targets == false then
JTACAutoLase(JTAC_DRONE_A2G10_NAME, 1688, false, "all")
end
...
if jtac_smoke_targets == true then
JTACAutoLase(JTAC_DRONE_MR1_NAME, 1688, true, "all")
end

if jtac_smoke_targets == false then
JTACAutoLase(JTAC_DRONE_MR1_NAME, 1688, false, "all")
end
...
if jtac_smoke_targets == true then
JTACAutoLase(JTAC_DRONE_MR2_NAME, 1688, true, "all")
end

if jtac_smoke_targets == false then
JTACAutoLase(JTAC_DRONE_MR2_NAME, 1688, false, "all")
end
...
if jtac_smoke_targets == true then
JTACAutoLase(JTAC_DRONE_MR3_NAME, 1688, true, "all")
end

if jtac_smoke_targets == false then
JTACAutoLase(JTAC_DRONE_MR3_NAME, 1688, false, "all")
end
...
if jtac_smoke_targets == true then
JTACAutoLase(JTAC_DRONE_MR4_NAME, 1688, true, "all")
end

if jtac_smoke_targets == false then
JTACAutoLase(JTAC_DRONE_MR4_NAME, 1688, false, "all")
end
...
if jtac_smoke_targets == true then
JTACAutoLase(JTAC_DRONE_MR5_NAME, 1688, true, "all")
end

if jtac_smoke_targets == false then
JTACAutoLase(JTAC_DRONE_MR5_NAME, 1688, false, "all")
end
...
if jtac_smoke_targets == true then
JTACAutoLase(JTAC_DRONE_MR6_NAME, 1688, true, "all")
end

if jtac_smoke_targets == false then
JTACAutoLase(JTAC_DRONE_MR6_NAME, 1688, false, "all")
end
...
if jtac_smoke_targets == true then
JTACAutoLase(JTAC_DRONE_MR7_NAME, 1688, true, "all")
end

if jtac_smoke_targets == false then
JTACAutoLase(JTAC_DRONE_MR7_NAME, 1688, false, "all")
end
...
if jtac_smoke_targets == true then
JTACAutoLase(JTAC_DRONE_MR8_NAME, 1688, true, "all")
end

if jtac_smoke_targets == false then
JTACAutoLase(JTAC_DRONE_MR8_NAME, 1688, false, "all")
end
...
if jtac_smoke_targets == true then
JTACAutoLase(JTAC_DRONE_MR9_NAME, 1688, true, "all")
end

if jtac_smoke_targets == false then
JTACAutoLase(JTAC_DRONE_MR9_NAME, 1688, false, "all")
end
...
if jtac_smoke_targets == true then
JTACAutoLase(JTAC_DRONE_MR10_NAME, 1688, true, "all")
end

if jtac_smoke_targets == false then
JTACAutoLase(JTAC_DRONE_MR10_NAME, 1688, false, "all")
end
...
if jtac_smoke_targets == true then
JTACAutoLase(JTAC_DRONE_AGH1_NAME, 1688, true, "all")
end

if jtac_smoke_targets == false then
JTACAutoLase(JTAC_DRONE_AGH1_NAME, 1688, false, "all")
end
...
if jtac_smoke_targets == true then
JTACAutoLase(JTAC_DRONE_AGH2_NAME, 1688, true, "all")
end

if jtac_smoke_targets == false then
JTACAutoLase(JTAC_DRONE_AGH2_NAME, 1688, false, "all")
end
...
if jtac_smoke_targets == true then
JTACAutoLase(JTAC_DRONE_AGH3_NAME, 1688, true, "all")
end

if jtac_smoke_targets == false then
JTACAutoLase(JTAC_DRONE_AGH3_NAME, 1688, false, "all")
end
...
if jtac_smoke_targets == true then
JTACAutoLase(JTAC_DRONE_AGH4_NAME, 1688, true, "all")
end

if jtac_smoke_targets == false then
JTACAutoLase(JTAC_DRONE_AGH4_NAME, 1688, false, "all")
end
...
if jtac_smoke_targets == true then
JTACAutoLase(JTAC_DRONE_AGH5_NAME, 1688, true, "all")
end

if jtac_smoke_targets == false then
JTACAutoLase(JTAC_DRONE_AGH5_NAME, 1688, false, "all")
end
...
if jtac_smoke_targets == true then
JTACAutoLase(JTAC_DRONE_AGH6_NAME, 1688, true, "all")
end

if jtac_smoke_targets == false then
JTACAutoLase(JTAC_DRONE_AGH6_NAME, 1688, false, "all")
end
...
if jtac_smoke_targets == true then
JTACAutoLase(JTAC_DRONE_AGH7_NAME, 1688, true, "all")
end

if jtac_smoke_targets == false then
JTACAutoLase(JTAC_DRONE_AGH7_NAME, 1688, false, "all")
end
...
if jtac_smoke_targets == true then
JTACAutoLase(JTAC_DRONE_AGH8_NAME, 1688, true, "all")
end

if jtac_smoke_targets == false then
JTACAutoLase(JTAC_DRONE_AGH8_NAME, 1688, false, "all")
end
...
if jtac_smoke_targets == true then
JTACAutoLase(JTAC_DRONE_AGH9_NAME, 1688, true, "all")
end

if jtac_smoke_targets == false then
JTACAutoLase(JTAC_DRONE_AGH9_NAME, 1688, false, "all")
end
...
if jtac_smoke_targets == true then
JTACAutoLase(JTAC_DRONE_AGH10_NAME, 1688, true, "all")
end

if jtac_smoke_targets == false then
JTACAutoLase(JTAC_DRONE_AGH10_NAME, 1688, false, "all")
end
