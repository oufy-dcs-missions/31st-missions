...
function SEF_SetukasSword()
	...
	if ( GROUP:FindByName(USAFHAWKEYEGROUPNAME) ~= nil and GROUP:FindByName(USAFHAWKEYEGROUPNAME):IsAlive() ) then				
		...
		local SpawnUnits = GROUP:FindByName(USAFHAWKEYEGROUPNAME):GetUnits()
		...
		for UnitID, UnitData in pairs( SpawnUnits ) do
			...
			--////Existing Timestamp
			if ( USAFHAWKEYE_DATA[UnitID].Vec2 ~= nil and USAFHAWKEYE_DATA[UnitID].TimeStamp ~= nil ) then
				--////On Ground And Stationary
				if SpawnUnit:InAir() == false and SpawnUnit:GetVelocityKMH() < 1 then
					local NewVec2 = SpawnUnit:GetVec2()
					if USAFHAWKEYE_DATA[UnitID].Vec2.x == NewVec2.x and USAFHAWKEYE_DATA[UnitID].Vec2.y == NewVec2.y then
						if USAFHAWKEYE_DATA[UnitID].TimeStamp + CleanupTime < timer.getTime() then						
							env.info("HAWKEYE Monitor - Deleting: "..SpawnUnitName.." Due To Inactivity", false)
							USAFHAWKEYE_DATA[UnitID].Vec2 = nil
							USAFHAWKEYE_DATA[UnitID].TimeStamp = nil
							Unit.getByName(SpawnUnit:GetName()):destroy()						
						end
					else
						USAFHAWKEYE_DATA[UnitID].TimeStamp = timer.getTime()
						USAFHAWKEYE_DATA[UnitID].Vec2 = SpawnUnit:GetVec2()
					end    		
				...
				elseif (SpawnUnit:InAir() == false and (string.find(SpawnUnitName, "USAF Hawkeye"))) then
					if (( SpawnUnit:GetVelocityKMH() > 1 and SpawnUnit:GetVelocityKMH() < 41 ) and ( SpawnUnit:GetAltitude() > 5 and SpawnUnit:GetAltitude() < 25 )) then 
						if USAFHAWKEYE_DATA[UnitID].TimeStamp + CleanupTime < timer.getTime() then																		
							env.info("HAWKEYE Monitor - Deleting Navy Unit: "..SpawnUnitName.." Due To Inactivity", false)
							USAFHAWKEYE_DATA[UnitID].Vec2 = nil
							USAFHAWKEYE_DATA[UnitID].TimeStamp = nil						
							Unit.getByName(SpawnUnit:GetName()):destroy()						
						end
			...
			--////No Existing Timestamp
				...
				if SpawnUnit:InAir() == false then					
					...
					elseif (string.find(SpawnUnitName, "USAF Hawkeye")) then
						if (( SpawnUnit:GetVelocityKMH() > 1 and SpawnUnit:GetVelocityKMH() < 41 ) and ( SpawnUnit:GetAltitude() > 5 and SpawnUnit:GetAltitude() < 25 )) then
							USAFHAWKEYE_DATA[UnitID].TimeStamp = timer.getTime()
							USAFHAWKEYE_DATA[UnitID].Vec2 = SpawnUnit:GetVec2()
						end					
	...
	if ( GROUP:FindByName(BLUESQUADRON1GROUPNAME) ~= nil and GROUP:FindByName(BLUESQUADRON1GROUPNAME):IsAlive() ) then				
		...
		for UnitID, UnitData in pairs( SpawnUnits ) do
			...
			if ( BLUESQUADRON1_DATA[UnitID].Vec2 ~= nil and BLUESQUADRON1_DATA[UnitID].TimeStamp ~= nil ) then
				...
				--////On Carrier Deck And Stationary - Special For Carrier Planes, Don't Base On Vec Point Just Check Speed, Altitude And Timestamp
				elseif (SpawnUnit:InAir() == false and (string.find(SpawnUnitName, BlueSquadronName1))) then
					if (( SpawnUnit:GetVelocityKMH() > 1 and SpawnUnit:GetVelocityKMH() < 41 ) and ( SpawnUnit:GetAltitude() > 5 and SpawnUnit:GetAltitude() < 25 )) then 
						if BLUESQUADRON1_DATA[UnitID].TimeStamp + CleanupTime < timer.getTime() then																		
			...
			--////No Existing Timestamp
				...
				if SpawnUnit:InAir() == false then					
					if SpawnUnit:GetVelocityKMH() < 1 then
						...
						BLUESQUADRON1_DATA[UnitID].Vec2 = SpawnUnit:GetVec2()
					--Special for Carrier Planes
					elseif (string.find(SpawnUnitName, BlueSquadronName1)) then
						if (( SpawnUnit:GetVelocityKMH() > 1 and SpawnUnit:GetVelocityKMH() < 41 ) and ( SpawnUnit:GetAltitude() > 5 and SpawnUnit:GetAltitude() < 25 )) then
							BLUESQUADRON1_DATA[UnitID].TimeStamp = timer.getTime()
							BLUESQUADRON1_DATA[UnitID].Vec2 = SpawnUnit:GetVec2()
						end					
	...
	if ( GROUP:FindByName(BLUESQUADRON2GROUPNAME) ~= nil and GROUP:FindByName(BLUESQUADRON2GROUPNAME):IsAlive() ) then				
		...
		for UnitID, UnitData in pairs( SpawnUnits ) do
			...
			if ( BLUESQUADRON2_DATA[UnitID].Vec2 ~= nil and BLUESQUADRON2_DATA[UnitID].TimeStamp ~= nil ) then
				...
				--////On Carrier Deck And Stationary - Special For Carrier Planes, Don't Base On Vec Point Just Check Speed, Altitude And Timestamp
				elseif (SpawnUnit:InAir() == false and (string.find(SpawnUnitName, BlueSquadronName2))) then
					if (( SpawnUnit:GetVelocityKMH() > 1 and SpawnUnit:GetVelocityKMH() < 41 ) and ( SpawnUnit:GetAltitude() > 5 and SpawnUnit:GetAltitude() < 25 )) then 
						if BLUESQUADRON2_DATA[UnitID].TimeStamp + CleanupTime < timer.getTime() then																		
			...
			--////No Existing Timestamp
				...
				if SpawnUnit:InAir() == false then					
					if SpawnUnit:GetVelocityKMH() < 1 then
						...
						BLUESQUADRON2_DATA[UnitID].Vec2 = SpawnUnit:GetVec2()
					--Special for Carrier Planes
					elseif (string.find(SpawnUnitName, BlueSquadronName2)) then
						if (( SpawnUnit:GetVelocityKMH() > 1 and SpawnUnit:GetVelocityKMH() < 41 ) and ( SpawnUnit:GetAltitude() > 5 and SpawnUnit:GetAltitude() < 25 )) then
							BLUESQUADRON2_DATA[UnitID].TimeStamp = timer.getTime()
							BLUESQUADRON2_DATA[UnitID].Vec2 = SpawnUnit:GetVec2()
						end					
	...
	if ( GROUP:FindByName(BLUESQUADRON3GROUPNAME) ~= nil and GROUP:FindByName(BLUESQUADRON3GROUPNAME):IsAlive() ) then				
		...
		for UnitID, UnitData in pairs( SpawnUnits ) do
			...
			if ( BLUESQUADRON3_DATA[UnitID].Vec2 ~= nil and BLUESQUADRON3_DATA[UnitID].TimeStamp ~= nil ) then
				...
				--////On Carrier Deck And Stationary - Special For Carrier Planes, Don't Base On Vec Point Just Check Speed, Altitude And Timestamp
				elseif (SpawnUnit:InAir() == false and (string.find(SpawnUnitName, BlueSquadronName3))) then
					if (( SpawnUnit:GetVelocityKMH() > 1 and SpawnUnit:GetVelocityKMH() < 41 ) and ( SpawnUnit:GetAltitude() > 5 and SpawnUnit:GetAltitude() < 25 )) then 
						if BLUESQUADRON3_DATA[UnitID].TimeStamp + CleanupTime < timer.getTime() then																		
			...
			--////No Existing Timestamp
				...
				if SpawnUnit:InAir() == false then					
					if SpawnUnit:GetVelocityKMH() < 1 then
						...
						BLUESQUADRON3_DATA[UnitID].Vec2 = SpawnUnit:GetVec2()
					--Special for Carrier Planes
					elseif (string.find(SpawnUnitName, BlueSquadronName3)) then
						if (( SpawnUnit:GetVelocityKMH() > 1 and SpawnUnit:GetVelocityKMH() < 41 ) and ( SpawnUnit:GetAltitude() > 5 and SpawnUnit:GetAltitude() < 25 )) then
							BLUESQUADRON3_DATA[UnitID].TimeStamp = timer.getTime()
							BLUESQUADRON3_DATA[UnitID].Vec2 = SpawnUnit:GetVec2()
						end					
	...
	if ( GROUP:FindByName(BLUESQUADRON4GROUPNAME) ~= nil and GROUP:FindByName(BLUESQUADRON4GROUPNAME):IsAlive() ) then				
		...
		for UnitID, UnitData in pairs( SpawnUnits ) do
			...
			if ( BLUESQUADRON4_DATA[UnitID].Vec2 ~= nil and BLUESQUADRON4_DATA[UnitID].TimeStamp ~= nil ) then
				...
				--////On Carrier Deck And Stationary - Special For Carrier Planes, Don't Base On Vec Point Just Check Speed, Altitude And Timestamp
				elseif (SpawnUnit:InAir() == false and (string.find(SpawnUnitName, BlueSquadronName4))) then
					if (( SpawnUnit:GetVelocityKMH() > 1 and SpawnUnit:GetVelocityKMH() < 41 ) and ( SpawnUnit:GetAltitude() > 5 and SpawnUnit:GetAltitude() < 25 )) then 
						if BLUESQUADRON4_DATA[UnitID].TimeStamp + CleanupTime < timer.getTime() then																		
							env.info("BLUESQUADRON4 Monitor - Deleting Navy Unit: "..SpawnUnitName.." Due To Inactivity", false)
							BLUESQUADRON4_DATA[UnitID].Vec2 = nil
							BLUESQUADRON4_DATA[UnitID].TimeStamp = nil						
							Unit.getByName(SpawnUnit:GetName()):destroy()						
						end
			...
			--////No Existing Timestamp
				...
				if SpawnUnit:InAir() == false then					
					if SpawnUnit:GetVelocityKMH() < 1 then
						...
						BLUESQUADRON4_DATA[UnitID].Vec2 = SpawnUnit:GetVec2()
					--Special for Carrier Planes
					elseif (string.find(SpawnUnitName, BlueSquadronName4)) then
						if (( SpawnUnit:GetVelocityKMH() > 1 and SpawnUnit:GetVelocityKMH() < 41 ) and ( SpawnUnit:GetAltitude() > 5 and SpawnUnit:GetAltitude() < 25 )) then
							BLUESQUADRON4_DATA[UnitID].TimeStamp = timer.getTime()
							BLUESQUADRON4_DATA[UnitID].Vec2 = SpawnUnit:GetVec2()
						end					
	...
	if ( GROUP:FindByName(IRIAFMI8GROUPNAME) ~= nil and GROUP:FindByName(IRIAFMI8GROUPNAME):IsAlive() ) then				
		...
		for UnitID, UnitData in pairs( SpawnUnits ) do
			...
			if ( IRIAFMI8_DATA[UnitID].Vec2 ~= nil and IRIAFMI8_DATA[UnitID].TimeStamp ~= nil ) then
				...
				--////On Carrier Deck And Stationary - Special For Carrier Planes, Don't Base On Vec Point Just Check Speed, Altitude And Timestamp
				elseif (SpawnUnit:InAir() == false and (string.find(SpawnUnitName, "IRIAF Mi%-8MTV2"))) then
					if (( SpawnUnit:GetVelocityKMH() > 1 and SpawnUnit:GetVelocityKMH() < 41 ) and ( SpawnUnit:GetAltitude() > 5 and SpawnUnit:GetAltitude() < 25 )) then 
						if IRIAFMI8_DATA[UnitID].TimeStamp + CleanupTime < timer.getTime() then																		
			...
			--////No Existing Timestamp
				...
				if SpawnUnit:InAir() == false then					
					if SpawnUnit:GetVelocityKMH() < 1 then
						...
						IRIAFMI8_DATA[UnitID].Vec2 = SpawnUnit:GetVec2()
					--Special for Carrier Planes
					elseif (string.find(SpawnUnitName, "IRIAF Mi%-8MTV2")) then
						if (( SpawnUnit:GetVelocityKMH() > 1 and SpawnUnit:GetVelocityKMH() < 41 ) and ( SpawnUnit:GetAltitude() > 5 and SpawnUnit:GetAltitude() < 25 )) then
							IRIAFMI8_DATA[UnitID].TimeStamp = timer.getTime()
							IRIAFMI8_DATA[UnitID].Vec2 = SpawnUnit:GetVec2()
						end					
	...
	--////USAF AH-64D
	if ( GROUP:FindByName(USAFAH64DGROUPNAME) ~= nil and GROUP:FindByName(USAFAH64DGROUPNAME):IsAlive() ) then				
		
		local SpawnUnits = GROUP:FindByName(USAFAH64DGROUPNAME):GetUnits()
		...
		for UnitID, UnitData in pairs( SpawnUnits ) do
			...
			--////Existing Timestamp
			if ( USAFAH64D_DATA[UnitID].Vec2 ~= nil and USAFAH64D_DATA[UnitID].TimeStamp ~= nil ) then
				--////On Ground And Stationary
				if SpawnUnit:InAir() == false and SpawnUnit:GetVelocityKMH() < 1 then
					local NewVec2 = SpawnUnit:GetVec2()
					if USAFAH64D_DATA[UnitID].Vec2.x == NewVec2.x and USAFAH64D_DATA[UnitID].Vec2.y == NewVec2.y then
						if USAFAH64D_DATA[UnitID].TimeStamp + CleanupTime < timer.getTime() then						
							env.info("USAFAH64D Monitor - Deleting: "..SpawnUnitName.." Due To Inactivity", false)
							USAFAH64D_DATA[UnitID].Vec2 = nil
							USAFAH64D_DATA[UnitID].TimeStamp = nil
							Unit.getByName(SpawnUnit:GetName()):destroy()						
						end
					else
						USAFAH64D_DATA[UnitID].TimeStamp = timer.getTime()
						USAFAH64D_DATA[UnitID].Vec2 = SpawnUnit:GetVec2()
					end    		
				--////On Carrier Deck And Stationary - Special For Carrier Planes, Don't Base On Vec Point Just Check Speed, Altitude And Timestamp
				elseif (SpawnUnit:InAir() == false and (string.find(SpawnUnitName, "USAF AH%-64D"))) then
					if (( SpawnUnit:GetVelocityKMH() > 1 and SpawnUnit:GetVelocityKMH() < 41 ) and ( SpawnUnit:GetAltitude() > 5 and SpawnUnit:GetAltitude() < 25 )) then 
						if USAFAH64D_DATA[UnitID].TimeStamp + CleanupTime < timer.getTime() then																		
							env.info("USAFAH64D Monitor - Deleting Navy Unit: "..SpawnUnitName.." Due To Inactivity", false)
							USAFAH64D_DATA[UnitID].Vec2 = nil
							USAFAH64D_DATA[UnitID].TimeStamp = nil						
							Unit.getByName(SpawnUnit:GetName()):destroy()						
						end
			...
			--////No Existing Timestamp
				...
				if SpawnUnit:InAir() == false then					
					if SpawnUnit:GetVelocityKMH() < 1 then
						...
						USAFAH64D_DATA[UnitID].Vec2 = SpawnUnit:GetVec2()
					--Special for Carrier Planes
					elseif (string.find(SpawnUnitName, "USAF AH%-64D")) then
						if (( SpawnUnit:GetVelocityKMH() > 1 and SpawnUnit:GetVelocityKMH() < 41 ) and ( SpawnUnit:GetAltitude() > 5 and SpawnUnit:GetAltitude() < 25 )) then
							USAFAH64D_DATA[UnitID].TimeStamp = timer.getTime()
							USAFAH64D_DATA[UnitID].Vec2 = SpawnUnit:GetVec2()
						end					
	...
	--////USAFAH64D NOT ALIVE SCRUB DATA
	else
	...
	--////SYAAF MI-24P
	if ( GROUP:FindByName(SYAAFMI24PGROUPNAME) ~= nil and GROUP:FindByName(SYAAFMI24PGROUPNAME):IsAlive() ) then				
		
		local SpawnUnits = GROUP:FindByName(SYAAFMI24PGROUPNAME):GetUnits()
		...
		for UnitID, UnitData in pairs( SpawnUnits ) do
			...
			--////Existing Timestamp
			if ( SYAAFMI24P_DATA[UnitID].Vec2 ~= nil and SYAAFMI24P_DATA[UnitID].TimeStamp ~= nil ) then
				--////On Ground And Stationary
				if SpawnUnit:InAir() == false and SpawnUnit:GetVelocityKMH() < 1 then
					local NewVec2 = SpawnUnit:GetVec2()
					if SYAAFMI24P_DATA[UnitID].Vec2.x == NewVec2.x and SYAAFMI24P_DATA[UnitID].Vec2.y == NewVec2.y then
						if SYAAFMI24P_DATA[UnitID].TimeStamp + CleanupTime < timer.getTime() then						
							env.info("SYAAFMI24P Monitor - Deleting: "..SpawnUnitName.." Due To Inactivity", false)
							SYAAFMI24P_DATA[UnitID].Vec2 = nil
							SYAAFMI24P_DATA[UnitID].TimeStamp = nil
							Unit.getByName(SpawnUnit:GetName()):destroy()						
						end
					else
						SYAAFMI24P_DATA[UnitID].TimeStamp = timer.getTime()
						SYAAFMI24P_DATA[UnitID].Vec2 = SpawnUnit:GetVec2()
					end    		
				--////On Carrier Deck And Stationary - Special For Carrier Planes, Don't Base On Vec Point Just Check Speed, Altitude And Timestamp
				elseif (SpawnUnit:InAir() == false and (string.find(SpawnUnitName, "SyAAF Mi%-24P"))) then
					if (( SpawnUnit:GetVelocityKMH() > 1 and SpawnUnit:GetVelocityKMH() < 41 ) and ( SpawnUnit:GetAltitude() > 5 and SpawnUnit:GetAltitude() < 25 )) then 
						if SYAAFMI24P_DATA[UnitID].TimeStamp + CleanupTime < timer.getTime() then																		
							env.info("SYAAFMI24P Monitor - Deleting Navy Unit: "..SpawnUnitName.." Due To Inactivity", false)
							SYAAFMI24P_DATA[UnitID].Vec2 = nil
							SYAAFMI24P_DATA[UnitID].TimeStamp = nil						
							Unit.getByName(SpawnUnit:GetName()):destroy()						
						end
			...
			--////No Existing Timestamp
				...
				if SpawnUnit:InAir() == false then					
					if SpawnUnit:GetVelocityKMH() < 1 then
						...
						SYAAFMI24P_DATA[UnitID].Vec2 = SpawnUnit:GetVec2()
					--Special for Carrier Planes
					elseif (string.find(SpawnUnitName, "SyAAF Mi%-24P")) then
						if (( SpawnUnit:GetVelocityKMH() > 1 and SpawnUnit:GetVelocityKMH() < 41 ) and ( SpawnUnit:GetAltitude() > 5 and SpawnUnit:GetAltitude() < 25 )) then
							SYAAFMI24P_DATA[UnitID].TimeStamp = timer.getTime()
							SYAAFMI24P_DATA[UnitID].Vec2 = SpawnUnit:GetVec2()
						end					
	...
	--////SYAAFMI24P NOT ALIVE SCRUB DATA
	else
	...
	if ( GROUP:FindByName(BLUEHELOGROUPNAME) ~= nil and GROUP:FindByName(BLUEHELOGROUPNAME):IsAlive() ) then				
		...
		local SpawnUnits = GROUP:FindByName(BLUEHELOGROUPNAME):GetUnits()
		...
		for UnitID, UnitData in pairs( SpawnUnits ) do
			...
			--////Existing Timestamp
			if ( BLUEHELO_DATA[UnitID].Vec2 ~= nil and BLUEHELO_DATA[UnitID].TimeStamp ~= nil ) then
				--////On Ground And Stationary
				if SpawnUnit:InAir() == false and SpawnUnit:GetVelocityKMH() < 1 then
					local NewVec2 = SpawnUnit:GetVec2()
					if BLUEHELO_DATA[UnitID].Vec2.x == NewVec2.x and BLUEHELO_DATA[UnitID].Vec2.y == NewVec2.y then
						if BLUEHELO_DATA[UnitID].TimeStamp + CleanupTime < timer.getTime() then						
							env.info("BLUEHELO Monitor - Deleting: "..SpawnUnitName.." Due To Inactivity", false)
							BLUEHELO_DATA[UnitID].Vec2 = nil
							BLUEHELO_DATA[UnitID].TimeStamp = nil
							Unit.getByName(SpawnUnit:GetName()):destroy()						
						end
					else
						BLUEHELO_DATA[UnitID].TimeStamp = timer.getTime()
						BLUEHELO_DATA[UnitID].Vec2 = SpawnUnit:GetVec2()
					end    		
				--////On Carrier Deck And Stationary - Special For Carrier Planes, Don't Base On Vec Point Just Check Speed, Altitude And Timestamp
				elseif (SpawnUnit:InAir() == false and (string.find(SpawnUnitName, BlueHeloName))) then
					if (( SpawnUnit:GetVelocityKMH() > 1 and SpawnUnit:GetVelocityKMH() < 41 ) and ( SpawnUnit:GetAltitude() > 5 and SpawnUnit:GetAltitude() < 25 )) then 
						if BLUEHELO_DATA[UnitID].TimeStamp + CleanupTime < timer.getTime() then																		
							env.info("BLUEHELO Monitor - Deleting Navy Unit: "..SpawnUnitName.." Due To Inactivity", false)
							BLUEHELO_DATA[UnitID].Vec2 = nil
							BLUEHELO_DATA[UnitID].TimeStamp = nil						
							Unit.getByName(SpawnUnit:GetName()):destroy()						
						end
			...
			--////No Existing Timestamp
				...
				if SpawnUnit:InAir() == false then					
					if SpawnUnit:GetVelocityKMH() < 1 then
						...
						BLUEHELO_DATA[UnitID].Vec2 = SpawnUnit:GetVec2()
					--Special for Carrier Planes
					elseif (string.find(SpawnUnitName, BlueHeloName)) then
						if (( SpawnUnit:GetVelocityKMH() > 1 and SpawnUnit:GetVelocityKMH() < 41 ) and ( SpawnUnit:GetAltitude() > 5 and SpawnUnit:GetAltitude() < 25 )) then
							BLUEHELO_DATA[UnitID].TimeStamp = timer.getTime()
							BLUEHELO_DATA[UnitID].Vec2 = SpawnUnit:GetVec2()
						end					
	...
	if ( GROUP:FindByName(REDHELOGROUPNAME) ~= nil and GROUP:FindByName(REDHELOGROUPNAME):IsAlive() ) then				
		...
		local SpawnUnits = GROUP:FindByName(REDHELOGROUPNAME):GetUnits()
		...
		for UnitID, UnitData in pairs( SpawnUnits ) do
			...
			--////Existing Timestamp
			if ( REDHELO_DATA[UnitID].Vec2 ~= nil and REDHELO_DATA[UnitID].TimeStamp ~= nil ) then
				--////On Ground And Stationary
				if SpawnUnit:InAir() == false and SpawnUnit:GetVelocityKMH() < 1 then
					local NewVec2 = SpawnUnit:GetVec2()
					if REDHELO_DATA[UnitID].Vec2.x == NewVec2.x and REDHELO_DATA[UnitID].Vec2.y == NewVec2.y then
						if REDHELO_DATA[UnitID].TimeStamp + CleanupTime < timer.getTime() then						
							env.info("REDHELO Monitor - Deleting: "..SpawnUnitName.." Due To Inactivity", false)
							REDHELO_DATA[UnitID].Vec2 = nil
							REDHELO_DATA[UnitID].TimeStamp = nil
							Unit.getByName(SpawnUnit:GetName()):destroy()						
						end
					else
						REDHELO_DATA[UnitID].TimeStamp = timer.getTime()
						REDHELO_DATA[UnitID].Vec2 = SpawnUnit:GetVec2()
					end    		
				--////On Carrier Deck And Stationary - Special For Carrier Planes, Don't Base On Vec Point Just Check Speed, Altitude And Timestamp
				elseif (SpawnUnit:InAir() == false and (string.find(SpawnUnitName, RedHeloName))) then
					if (( SpawnUnit:GetVelocityKMH() > 1 and SpawnUnit:GetVelocityKMH() < 41 ) and ( SpawnUnit:GetAltitude() > 5 and SpawnUnit:GetAltitude() < 25 )) then 
						if REDHELO_DATA[UnitID].TimeStamp + CleanupTime < timer.getTime() then																		
							env.info("REDHELO Monitor - Deleting Navy Unit: "..SpawnUnitName.." Due To Inactivity", false)
							REDHELO_DATA[UnitID].Vec2 = nil
							REDHELO_DATA[UnitID].TimeStamp = nil						
							Unit.getByName(SpawnUnit:GetName()):destroy()						
						end
			...
			--////No Existing Timestamp
				...
				if SpawnUnit:InAir() == false then					
					if SpawnUnit:GetVelocityKMH() < 1 then
						...
						REDHELO_DATA[UnitID].Vec2 = SpawnUnit:GetVec2()
					--Special for Carrier Planes
					elseif (string.find(SpawnUnitName, RedHeloName)) then
						if (( SpawnUnit:GetVelocityKMH() > 1 and SpawnUnit:GetVelocityKMH() < 41 ) and ( SpawnUnit:GetAltitude() > 5 and SpawnUnit:GetAltitude() < 25 )) then
							REDHELO_DATA[UnitID].TimeStamp = timer.getTime()
							REDHELO_DATA[UnitID].Vec2 = SpawnUnit:GetVec2()
						end					
