...
):SetSpeed(Tanker_BOOM_Speed):SetRadio(255):SetModex(511):SetTACAN(
    24,
    'YPF'
...
):SetSpeed(Tanker_BASKET_Speed):SetRadio(257):SetModex(512):SetTACAN(
    25,
    'ARC'
):SetRacetrackDistances(50, 5):Start()
...
local awacs =
    ...
    251
):SetAltitude(20000):SetCallsign(CALLSIGN.AWACS.Wizard):SetRacetrackDistances(
    40,
    5
...
if enable_RescueHelos == true then
    local rescuehelo =
        RESCUEHELO:New(UNIT:FindByName('⚓ CVN-74 Stennis'), '☮ Rescate'):SetHomeBase(AIRBASE:FindByName('⚓ CVN-74 Stennis-2')):SetTakeoffAir(

    ):SetRespawnInAir():SetRescueDuration(1):SetModex(42):Start()

    local rescueheloB =
        RESCUEHELO:New(UNIT:FindByName('⚓ LHA-1 Tarawa'), '☮ Rescate'):SetHomeBase(AIRBASE:FindByName('⚓ LHA-1 Tarawa-1')):SetTakeoffAir(
