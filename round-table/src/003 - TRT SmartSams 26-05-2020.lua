...
function SEAD_launch:onEvent(event)
	...
	if event.id == world.event.S_EVENT_SHOT then -- Detect weapon being fired
		...
		if _SEADmissileName == "Kh-58U" or _SEADmissileName == "KH-25MPU" or _SEADmissileName == "AGM-88C" or _SEADmissileName == "AGM-122 Sidearm" or _SEADmissileName == "AGM-45A" or _SEADmissileName == "AGM-45B" or _SEADmissileName == "LD-10" then -- Check if the missile is a SEAD
...
env.info("TRT SMART SAM LOADED - NO ERRORS")