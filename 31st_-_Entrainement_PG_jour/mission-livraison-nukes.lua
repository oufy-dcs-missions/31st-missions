STATIC:FindByName( "bombes-1" ):Destroy(true)
STATIC:FindByName( "bombes-2" ):Destroy(true)
STATIC:FindByName( "bombes-3" ):Destroy(true)
STATIC:FindByName( "bombes-4" ):Destroy(true)
