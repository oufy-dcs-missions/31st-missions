...
REDCAPTURETEAM 	= SPAWN:NewWithAlias("Vehicle Template", "Chinese LUV Tigr"):InitRandomizeTemplate( { "Chinese LUV Tigr" } )
...
--////LOAD UNITS
if file_exists("SeaSlugUnitInterment.lua") then	
	
	dofile("SeaSlugUnitInterment.lua")
...
--////LOAD STATICS
if file_exists("SeaSlugStaticInterment.lua") then
	
	dofile("SeaSlugStaticInterment.lua")
...
--////LOAD AIRBASES
if file_exists("SeaSlugAirbases.lua") then

	dofile("SeaSlugAirbases.lua")
