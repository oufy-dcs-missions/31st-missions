--//////////////////////////////////////////////////////////
-- Name: Operation Sea Slug - Templates
-- Author: Surrexen    ༼ つ ◕_◕ ༽つ    (づ｡◕‿◕｡)づ
--//////////////////////////////////////////////////////////

--////AIRFRAMES
local KPAAF_AIR_TABLE		= {}
local KPAAF_AIR_INDEX		= 0
local PLAAF_AIR_TABLE		= {}
local PLAAF_AIR_INDEX		= 0
...
local PLAAF_GROUND_TABLE	= {}
local PLAAF_GROUND_INDEX	= 0
local SYAAF_GROUND_TABLE 	= {}
local SYAAF_GROUND_INDEX 	= 0

--////WHIRLEY THINGS
local PLAAF_HELO_TABLE		= {}
local PLAAF_HELO_INDEX		= 0
	...
	[3] = {		
		...
		["units"] = 
		{
			[1] = 
			{
				...
				["hardpoint_racks"] = true,
				["alt_type"] = "BARO",
				["livery_id"] = "DPRK Mig-29A(no slogan)",
				["skill"] = "High",
				["speed"] = 234.32754852983,
				["type"] = "MiG-29A",
				["psi"] = 0,
	...
	[1] = {		
		...
		["units"] = 
		{
			[1] = 
			{
				...
				["hardpoint_racks"] = true,
				["alt_type"] = "BARO",
				["livery_id"] = "PLAAF 33th AD (Reworked)",
				["skill"] = "High",
				["speed"] = 234.32754852983,
				["type"] = "J-11A",
				["psi"] = 0,
	...
	[2] = {		
		...
		["units"] = 
		{
			[1] = 
			{
				...
				["hardpoint_racks"] = true,
				["alt_type"] = "BARO",
				["livery_id"] = "PLAAF 125th AB (Fictional)",
				["skill"] = "High",
				["speed"] = 234.32754852983,
				["AddPropAircraft"] = 
				{
	...
	[10] = {		
		...
		["units"] = 
		{
			[1] = 
			{
				...
				["hardpoint_racks"] = true,
				["alt_type"] = "BARO",
				["livery_id"] = "PLAAF K2S new parade",
				["skill"] = "Excellent",
				["speed"] = 234.32754852983,
				["type"] = "Su-27",
				["psi"] = 0,
	...
	[13] = {		
		...
		["units"] = 
		{
			[1] = 
			{
				...
				["hardpoint_racks"] = true,
				["alt_type"] = "BARO",
				["livery_id"] = "PLAN Carrier Air Wings J-15",
				["skill"] = "High",
				["speed"] = 234.32754852983,
				["type"] = "Su-33",
				["psi"] = 0,
...
for i, Template in pairs(KPAAF_AIR_TEMPLATES) do 
	coalition.addGroup(country.id.NORTH_KOREA, Group.Category.AIRPLANE, Template)
	KPAAF_AIR_INDEX = KPAAF_AIR_INDEX + 1
	KPAAF_AIR_TABLE[KPAAF_AIR_INDEX] = GROUP:NewTemplate(Template, coalition.side.RED, Group.Category.AIRPLANE, country.id.NORTH_KOREA)        
end

for i, Template in pairs(PLAAF_AIR_TEMPLATES) do 
	coalition.addGroup(country.id.CHINA, Group.Category.AIRPLANE, Template)
	PLAAF_AIR_INDEX = PLAAF_AIR_INDEX + 1
	PLAAF_AIR_TABLE[PLAAF_AIR_INDEX] = GROUP:NewTemplate(Template, coalition.side.RED, Group.Category.AIRPLANE, country.id.CHINA)        
end
...
for i, Template in pairs(PLAAF_HELO_TEMPLATES) do 
	coalition.addGroup(country.id.CHINA, Group.Category.HELICOPTER, Template)
	PLAAF_HELO_INDEX = PLAAF_HELO_INDEX + 1
	PLAAF_HELO_TABLE[PLAAF_HELO_INDEX] = GROUP:NewTemplate(Template, coalition.side.RED, Group.Category.HELICOPTER, country.id.CHINA)	
end
...
for i, Template in pairs(PLAAF_GROUND_TEMPLATES) do 
	coalition.addGroup(country.id.CHINA, Group.Category.GROUND, Template)
	PLAAF_GROUND_INDEX = PLAAF_GROUND_INDEX + 1
	PLAAF_GROUND_TABLE[PLAAF_GROUND_INDEX] = GROUP:NewTemplate(Template, coalition.side.RED, Group.Category.GROUND, country.id.CHINA)	
end
