...
function EventHandlerHeloBirth:onEvent(Event)
	...
	if ( Event.id == world.event.S_EVENT_BIRTH and Event.initiator:getPlayerName() ~= nil ) then
		...
		if ( EventGroupType == "Hercules" or EventGroupType == "UH-1H" or EventGroupType == "Mi-8MT" or EventGroupType == "SA342L" or EventGroupType == "SA342M" or EventGroupType == "SA342Minigun" or EventGroupType == "SA342Mistral" or EventGroupType == "Ka-50" or EventGroupType == "Mi-24P" or EventGroupType == "UH-60L") then
