...
-- Epsilon - Tiyas -> Palmyra


-- Alpha   - Minakh -> Aleppo -> Kuweires -> Jirah -> Tabqa
-- Beta    - Bassel Al-Assad -> Hama -> Al Qusayr -> Abu al-Duhur -> Shayrat -> Tiyas -> Tabqa
-- Gamma   - Rene Mouawad -> Al Qusayr -> Shayrat -> Hama -> Tiyas -> Palmyra
-- Delta   - Mezzeh -> Khalkhalah -> Al-Dumayr -> An Nasiriyah -> Sayqal -> Tiyas -> Palmyra
-- Epsilon - Tiyas -> Palmyra
...
SEF_AIRBASEINFORMATION[1] = {				
		...
		Neighbours = { "Aleppo", "Kuweires", "Jirah", "Tabqa", "Palmyra", "Hama", "Al Qusayr", "Rene Mouawad", "Bassel Al-Assad", "Taftanaz", "Minakh", "Hatay", "Gaziantep", "Tiyas", "Shayrat"  },			
}	
...
SEF_AIRBASEINFORMATION[3] = {				
		AirbaseName = "Aleppo",
		Neighbours = { "Minakh", "Kuweires", "Jirah", "Tabqa", "Abu al-Duhur", "Taftanaz", "Hatay", "Bassel Al-Assad", "Hama", "Incirlik", "Adana Sakirpasa", "Al Qusayr", "Gaziantep", "Tiyas", "Shayrat" },		
}
...
SEF_AIRBASEINFORMATION[6] = {				
		...
		Neighbours = { "Hama", "Palmyra", "Rayak", "Al-Dumayr", "Mezzeh", "Bassel Al-Assad", "Rene Mouawad", "Wujah Al Hajar", "King Hussein Air College", "Beirut-Rafic Hariri", "Kiryat Shmona", "Khalkhalah", "Marj as Sultan North", "Marj as Sultan South", "Marj Ruhayyil", "Damascus", "Qabr as Sitt", "H4", "Tiyas", "Shayrat", "Sayqal", "Rosh Pina", "Naqoura", "Tha'lah" },		
}
...
SEF_AIRBASEINFORMATION[15] = {				
		AirbaseName = "Jirah",
		Neighbours = { "Tabqa", "Kuweires", "Abu al-Duhur", "Taftanaz", "Aleppo", "Minakh", "Hama", "Bassel Al-Assad", "Palmyra", "Hatay", "Gaziantep", "Tiyas", "Shayrat" },		
}
...
SEF_AIRBASEINFORMATION[19] = {				
		...
		Neighbours = { "Jirah", "Tabqa", "Abu al-Duhur", "Taftanaz", "Aleppo", "Minakh", "Hatay", "Bassel Al-Assad", "Hama", "Palmyra", "Gaziantep", "Tiyas", "Shayrat" },		
}
...
SEF_AIRBASEINFORMATION[25] = {				
		AirbaseName = "Minakh",
		Neighbours = { "Aleppo", "Kuweires", "Jirah", "Tabqa", "Abu al-Duhur", "Taftanaz", "Hatay", "Bassel Al-Assad", "Hama", "Incirlik", "Adana Sakirpasa", "Gaziantep" },		
}
SEF_AIRBASEINFORMATION[26] = {				
		AirbaseName = "Palmyra",
		Neighbours = { "Tabqa", "An Nasiriyah", "Al-Dumayr", "Hama", "Abu al-Duhur", "Jirah", "Kuweires", "Al Qusayr", "Tiyas", "Shayrat", "Sayqal" },		
}
...
SEF_AIRBASEINFORMATION[31] = {				
		AirbaseName = "Tabqa",
		Neighbours = { "Palmyra", "Hama", "Abu al-Duhur", "Taftanaz", "Aleppo", "Kuweires", "Jirah", "Minakh", "Gaziantep", "Tiyas" },		
}
...
SEF_AIRBASEINFORMATION[34] = {				
		...
		Neighbours = { "Adana Sakirpasa", "Incirlik", "Hatay", "Minakh", "Taftanaz", "Abu al-Duhur", "Aleppo", "Kuweires", "Jirah", "Tabqa" },		
}
SEF_AIRBASEINFORMATION[35] = {				
		AirbaseName = "H4",
		Neighbours = { "King Hussein Air College", "Tha'lah", "Khalkhalah", "Marj Ruhayyil", "Damascus", "Marj as Sultan North", "Marj as Sultan South", "Al-Dumayr", "Sayqal", "An Nasiriyah" },		
}
SEF_AIRBASEINFORMATION[36] = {				
		AirbaseName = "Tiyas",
		Neighbours = { "Aleppo", "Kuweires", "Jirah", "Tabqa", "Taftanaz", "Abu al-Duhur", "Bassel Al-Assad", "Hama", "Rene Mouawad", "Al Qusayr", "Shayrat", "Palmyra", "Wujah Al Hajar", "Rayak", "An Nasiriyah", "Sayqal", "Al-Dumayr", "Marj as Sultan North", "Marj as Sultan South", "Damascus", "Mezzeh", "Qabr as Sitt", "Marj Ruhayyil", "Khalkhalah" },		
}
SEF_AIRBASEINFORMATION[37] = {				
		AirbaseName = "Shayrat",
		Neighbours = { "Aleppo", "Kuweires", "Beirut-Rafic Hariri", "Taftanaz", "Abu al-Duhur", "Bassel Al-Assad", "Hama", "Rene Mouawad", "Al Qusayr", "Tiyas", "Palmyra", "Wujah Al Hajar", "Rayak", "An Nasiriyah", "Sayqal", "Al-Dumayr", "Marj as Sultan North", "Marj as Sultan South", "Damascus", "Mezzeh", "Qabr as Sitt", "Marj Ruhayyil", "Khalkhalah" },		
}
SEF_AIRBASEINFORMATION[38] = {				
		AirbaseName = "Sayqal",
		Neighbours = { "Hama", "Rene Mouawad", "Al Qusayr", "Shayrat", "Tiyas", "Palmyra", "Wujah Al Hajar", "Beirut-Rafic Hariri", "Rayak", "An Nasiriyah", "Al-Dumayr", "Marj as Sultan North", "Marj as Sultan South", "Damascus", "Mezzeh", "Qabr as Sitt", "Marj Ruhayyil", "Khalkhalah", "Tha'lah", "King Hussein Air College", "H4", "Rosh Pina", "Kiryat Shmona" },		
}
...
SEF_AIRBASEINFORMATION[51] = {				
		AirbaseName = "Deir es Zur",
		Neighbours = { "Tabqa", "Palmyra" },		
}
]]--
...
function SEF_REDSQUADRON2_DEPLOYMENT()
	...
	-- Bassel Al-Assad -> Hama -> Al Qusayr -> Abu al-Duhur -> Shayrat -> Tiyas -> Tabqa
...
function SEF_BLUEHELOSQUADRONSPAWN()
	...
	BLUEHELO = SPAWN:NewWithAlias("Helicopter Template", BlueHeloName):InitRandomizeTemplate( { "USAF AH-64D" } )	
