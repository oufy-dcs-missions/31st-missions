...
ScheduleIDGroupCobra = Scheduler:Schedule(nil, startUncontrolledAirGroup, { groupCobra }, 500, 20 )
-- *****************************************************************************
--                     **                     Nukes                           **
--                     *********************************************************
--
...
spawnUPS:InitRepeatOnEngineShutDown()
spawnChina:InitRepeatOnEngineShutDown()
spawnEasyJet:InitRepeatOnEngineShutDown()
spawnSingaporeAirlines:InitRepeatOnEngineShutDown()
spawnUPS:SpawnScheduled(900,0.6)
spawnChina:SpawnScheduled(900,0.6)
spawnEasyJet:SpawnScheduled(900,0.6)
spawnSingaporeAirlines:SpawnScheduled(900,0.6)
--                     *********************************************************
...
CAPZoneBandarEJask = ZONE_POLYGON:NewFromGroupName( "cap_bandar_e_jask_polygon2" )
InitCAP({CAPZoneBandarEJask, AIRBASE.PersianGulf.Bandar_Abbas_Intl, "BandarEJaskCAP", { "mig21cap" }, 16})
InitCAP({CAPZoneBandarEJask, AIRBASE.PersianGulf.Kerman_Airport, "BandarEJaskCAP2", { "jf17cap" }, 4})
