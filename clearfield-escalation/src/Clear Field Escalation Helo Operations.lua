--////////////////////////////////////////////////////////////
-- Name: Operation Clear Field Escalation - Helo Module MkII
...
CargoContainerLoadingZone[1] = {				
	ZoneName = "Anapa-Vityazevo Cargo Loading Zone"		
}
CargoContainerLoadingZone[2] = {				
	ZoneName = "Batumi Cargo Loading Zone"		
}
CargoContainerLoadingZone[3] = {				
	ZoneName = "Beslan Cargo Loading Zone"		
}
CargoContainerLoadingZone[4] = {				
	ZoneName = "Gelendzhik Cargo Loading Zone"		
}
CargoContainerLoadingZone[5] = {				
	ZoneName = "Gudauta Cargo Loading Zone"		
}
CargoContainerLoadingZone[6] = {				
	ZoneName = "Kobuleti Cargo Loading Zone"		
}
CargoContainerLoadingZone[7] = {				
	ZoneName = "Krasnodar-Center Cargo Loading Zone"		
}
CargoContainerLoadingZone[8] = {				
	ZoneName = "Krasnodar-Pashkovsky Cargo Loading Zone"		
}
CargoContainerLoadingZone[9] = {				
	ZoneName = "Krymsk Cargo Loading Zone"		
}
CargoContainerLoadingZone[10] = {				
	ZoneName = "Kutaisi Cargo Loading Zone"		
}
CargoContainerLoadingZone[11] = {				
	ZoneName = "Maykop-Khanskaya Cargo Loading Zone"		
}
CargoContainerLoadingZone[12] = {				
	ZoneName = "Mineralnye Vody Cargo Loading Zone"		
}
CargoContainerLoadingZone[13] = {				
	ZoneName = "Mozdok Cargo Loading Zone"		
}
CargoContainerLoadingZone[14] = {				
	ZoneName = "Nalchik Cargo Loading Zone"		
}
CargoContainerLoadingZone[15] = {				
	ZoneName = "Novorossiysk Cargo Loading Zone"		
}
CargoContainerLoadingZone[16] = {				
	ZoneName = "Senaki-Kolkhi Cargo Loading Zone"		
}
CargoContainerLoadingZone[17] = {				
	ZoneName = "Sochi-Adler Cargo Loading Zone"		
}
CargoContainerLoadingZone[18] = {				
	ZoneName = "Soganlug Cargo Loading Zone"		
}
CargoContainerLoadingZone[19] = {				
	ZoneName = "Sukhumi-Babushara Cargo Loading Zone"		
}
CargoContainerLoadingZone[20] = {				
	ZoneName = "Tbilisi-Lochini Cargo Loading Zone"		
}
CargoContainerLoadingZone[21] = {				
	ZoneName = "Vaziani Cargo Loading Zone"		
}
...
InfantryLoadingZone[1] = {				
	ZoneName = "Anapa-Vityazevo Infantry Loading Zone"		
}
InfantryLoadingZone[2] = {				
	ZoneName = "Batumi Infantry Loading Zone"		
}
InfantryLoadingZone[3] = {				
	ZoneName = "Beslan Infantry Loading Zone"		
}
InfantryLoadingZone[4] = {				
	ZoneName = "Gelendzhik Infantry Loading Zone"		
}
InfantryLoadingZone[5] = {				
	ZoneName = "Gudauta Infantry Loading Zone"		
}
InfantryLoadingZone[6] = {				
	ZoneName = "Kobuleti Infantry Loading Zone"		
}
InfantryLoadingZone[7] = {				
	ZoneName = "Krasnodar-Center Infantry Loading Zone"		
}
InfantryLoadingZone[8] = {				
	ZoneName = "Krasnodar-Pashkovsky Infantry Loading Zone"		
}
InfantryLoadingZone[9] = {				
	ZoneName = "Krymsk Infantry Loading Zone"		
}
InfantryLoadingZone[10] = {				
	ZoneName = "Kutaisi Infantry Loading Zone"		
}
InfantryLoadingZone[11] = {				
	ZoneName = "Maykop-Khanskaya Infantry Loading Zone"		
}
InfantryLoadingZone[12] = {				
	ZoneName = "Mineralnye Vody Infantry Loading Zone"		
}
InfantryLoadingZone[13] = {				
	ZoneName = "Mozdok Infantry Loading Zone"		
}
InfantryLoadingZone[14] = {				
	ZoneName = "Nalchik Infantry Loading Zone"		
}
InfantryLoadingZone[15] = {				
	ZoneName = "Novorossiysk Infantry Loading Zone"		
}
InfantryLoadingZone[16] = {				
	ZoneName = "Senaki-Kolkhi Infantry Loading Zone"		
}
InfantryLoadingZone[17] = {				
	ZoneName = "Sochi-Adler Infantry Loading Zone"		
}
InfantryLoadingZone[18] = {				
	ZoneName = "Soganlug Infantry Loading Zone"		
}
InfantryLoadingZone[19] = {				
	ZoneName = "Sukhumi-Babushara Infantry Loading Zone"		
}
InfantryLoadingZone[20] = {				
	ZoneName = "Tbilisi-Lochini Infantry Loading Zone"		
}
InfantryLoadingZone[21] = {				
	ZoneName = "Vaziani Infantry Loading Zone"		
}
...
INFANTRY = SPAWN:New("Infantry Squad"):OnSpawnGroup(
										function( SpawnGroup )	
...
STINGER = SPAWN:New("Stinger Squad"):OnSpawnGroup(
										function( SpawnGroup )	
...
USACE = SPAWN:New("USACE Squad"):OnSpawnGroup(
										function( SpawnGroup )	
...
USACEAVENGER = SPAWN:New("USACE Avenger"):OnSpawnGroup(
										function( SpawnGroup )	
...
USACEBRADLEY = SPAWN:New("USACE Bradley M6"):OnSpawnGroup(
										function( SpawnGroup )	
...
USACENASAMS = SPAWN:New("USACE NASAMS"):OnSpawnGroup(
										function( SpawnGroup )	
...
function SEF_SaveConstructedItemsTable(timeloop, time)
	...
	ConstructionStr = IntegratedserializeWithCycles("ClearFieldMkIIConstructions", ClearFieldMkIIConstructions)
	writemission(ConstructionStr, "ClearFieldMkIIConstructions.lua")
...
function SEF_UPDATECONSTRUCTIONTABLE()
	...
	if #USACEM818Table > 0 then
		for i = 1, #USACEM818Table do
			...
			ClearFieldMkIIConstructions[TableConstructor] = {}
			ClearFieldMkIIConstructions[TableConstructor].Type = "M818"
			ClearFieldMkIIConstructions[TableConstructor].Vec2X = ConstructedGroupVec2.x
			ClearFieldMkIIConstructions[TableConstructor].Vec2Y = ConstructedGroupVec2.y
	...
	if #USACEROLANDTable > 0 then
		for i = 1, #USACEROLANDTable do
			...
			ClearFieldMkIIConstructions[TableConstructor] = {}
			ClearFieldMkIIConstructions[TableConstructor].Type = "Roland ADS"
			ClearFieldMkIIConstructions[TableConstructor].Vec2X = ConstructedGroupVec2.x
			ClearFieldMkIIConstructions[TableConstructor].Vec2Y = ConstructedGroupVec2.y
	...
	if #USACEM1A2ABRAMSTable > 0 then
		for i = 1, #USACEM1A2ABRAMSTable do
			...
			ClearFieldMkIIConstructions[TableConstructor] = {}
			ClearFieldMkIIConstructions[TableConstructor].Type = "M1A2 Abrams"
			ClearFieldMkIIConstructions[TableConstructor].Vec2X = ConstructedGroupVec2.x
			ClearFieldMkIIConstructions[TableConstructor].Vec2Y = ConstructedGroupVec2.y
	...
	if #USACEAVENGERTable > 0 then
		for i = 1, #USACEAVENGERTable do
			...
			ClearFieldMkIIConstructions[TableConstructor] = {}
			ClearFieldMkIIConstructions[TableConstructor].Type = "Avenger"
			ClearFieldMkIIConstructions[TableConstructor].Vec2X = ConstructedGroupVec2.x
			ClearFieldMkIIConstructions[TableConstructor].Vec2Y = ConstructedGroupVec2.y
	...
	if #USACEBRADLEYTable > 0 then
		for i = 1, #USACEBRADLEYTable do
			...
			ClearFieldMkIIConstructions[TableConstructor] = {}
			ClearFieldMkIIConstructions[TableConstructor].Type = "Bradley"
			ClearFieldMkIIConstructions[TableConstructor].Vec2X = ConstructedGroupVec2.x
			ClearFieldMkIIConstructions[TableConstructor].Vec2Y = ConstructedGroupVec2.y
	...
	if #USACENASAMSTable > 0 then
		for i = 1, #USACENASAMSTable do
			--If The NASAMS Had Destroyed Units Skip It So A Replacement Can Be Built Manually?
			--if ( GROUP:FindByName(USACEHAWKTable[i]):GetSize() > 5 ) then
	...
	if #InfantryTable > 0 then
		for i = 1, #InfantryTable do		
			...
			if ( SquadObject ~= nil and SquadObject:IsAlive() == true and SquadObject:IsLoaded() == false and GROUP:FindByName(SquadObject:GetObjectName()):GetCoordinate():GetVec2() ~= nil ) then
				...
				ClearFieldMkIIConstructions[TableConstructor] = {}
				ClearFieldMkIIConstructions[TableConstructor].Type = "Rifle Infantry"
				ClearFieldMkIIConstructions[TableConstructor].Vec2X = ConstructedGroupVec2.x
				ClearFieldMkIIConstructions[TableConstructor].Vec2Y = ConstructedGroupVec2.y
	...
	if #StingerTable > 0 then
		for i = 1, #StingerTable do		
			...
			if ( SquadObject ~= nil and SquadObject:IsAlive() == true and SquadObject:IsLoaded() == false and GROUP:FindByName(SquadObject:GetObjectName()):GetCoordinate():GetVec2() ~= nil ) then
				...
				ClearFieldMkIIConstructions[TableConstructor] = {}
				ClearFieldMkIIConstructions[TableConstructor].Type = "Anti Air Infantry"
				ClearFieldMkIIConstructions[TableConstructor].Vec2X = ConstructedGroupVec2.x
				ClearFieldMkIIConstructions[TableConstructor].Vec2Y = ConstructedGroupVec2.y
	...
	if #USACETable > 0 then
		for i = 1, #USACETable do		
			...
			if ( SquadObject ~= nil and SquadObject:IsAlive() == true and SquadObject:IsLoaded() == false and GROUP:FindByName(SquadObject:GetObjectName()):GetCoordinate():GetVec2() ~= nil ) then
				...
				ClearFieldMkIIConstructions[TableConstructor] = {}
				ClearFieldMkIIConstructions[TableConstructor].Type = "USACE Engineers"
				ClearFieldMkIIConstructions[TableConstructor].Vec2X = ConstructedGroupVec2.x
				ClearFieldMkIIConstructions[TableConstructor].Vec2Y = ConstructedGroupVec2.y
	...
	if #CargoContainerTable > 0 then
		for i = 1, #CargoContainerTable do		
			...
			if ( CargoObject ~= nil and CargoObject:IsAlive() == true and CargoObject:IsLoaded() == false and CargoObject:GetCoordinate():GetVec2() ~= nil ) then
				...
				ClearFieldMkIIConstructions[TableConstructor] = {}
				ClearFieldMkIIConstructions[TableConstructor].Type = "Cargo Container"
				ClearFieldMkIIConstructions[TableConstructor].Vec2X = ConstructedGroupVec2.x
				ClearFieldMkIIConstructions[TableConstructor].Vec2Y = ConstructedGroupVec2.y
...
if file_exists("ClearFieldMkIIConstructions.lua") then	
	
	trigger.action.outText("Requisitioning Previously Constructed Items",15)
	
	dofile("ClearFieldMkIIConstructions.lua")
	
	ConstructedItemsTableLength = SEF_GetTableLength(ClearFieldMkIIConstructions)	
		
	for i = 1, ConstructedItemsTableLength do				
		local ConstructionType = ClearFieldMkIIConstructions[i].Type
		local ConstructionVec2X = ClearFieldMkIIConstructions[i].Vec2X
		local ConstructionVec2Y = ClearFieldMkIIConstructions[i].Vec2Y
...
function EventHandlerHeloBirth:onEvent(Event)
	...
	if ( Event.id == world.event.S_EVENT_BIRTH and Event.initiator:getPlayerName() ~= nil ) then
		...
		if ( EventGroupType == "Hercules" or EventGroupType == "UH-1H" or EventGroupType == "Mi-8MT" or EventGroupType == "SA342L" or EventGroupType == "SA342M" or EventGroupType == "SA342Minigun" or EventGroupType == "SA342Mistral" or EventGroupType == "Ka-50" or EventGroupType == "Mi-24P" ) then
